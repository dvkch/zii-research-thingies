...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "zii_research_thingies_production"

  # Mailer config
  config.action_mailer.asset_host = 'https://' + ENV['APP_HOST']
  config.action_mailer.default_options = { from: 'noreply@syan.me' }
  config.action_mailer.default_url_options = { protocol: 'https', host: ENV['APP_HOST'] }
